...
import { useBackgroundOperationStore, type BackgroundOperation } from "../api/backgroundOperationStore";
...
import { Activity, AlertTriangle, Check, Copy, Layers, RefreshCw, X } from "../../../shared/ui/icons";

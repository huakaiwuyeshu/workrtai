...
import type { ProjectImageFilePayload } from "../../../shared/types/index";
import type { MarkdownLinkBehavior } from "../../../shared/ui/MarkdownContent";
import { HistoryMarkdownContent } from "../components/HistoryMarkdownContent";
import {
  isGitStatusLine,
  renderTranscriptHighlights,
  renderTranscriptLineHighlights,
} from "../components/sessionTranscriptHighlighter";

...
import type { CreateSshHostInput, SshHost, SshHostGroup } from "../../../../shared/types/index";
...
import { SshHostAttachmentDialog } from "../../api/SshHostAttachmentDialog";
...
const ERROR_LABELS: Record<string, TranslationKey> = {
  ...
  ssh_attachment_root_invalid: "settings.sshHosts.error.attachmentRootInvalid",

...
test("exposes task lifecycle through tools/list and tools/call", async () => {
  ...
  assert.deepEqual(listed.tools.map((tool) => tool.name), ["create_task", "dispatch_task", "handoff_task", "ask_agent", "list_tasks", "recover_tasks", "post_progress", "post_result", "get_task", "checkpoint", "evaluate_gate"]);

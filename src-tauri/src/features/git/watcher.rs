...
impl GitWatcherBridge {
    ...
    // 拒绝缺失或 WSL 路径，替换旧监听器并去抖推送相关 Git 变化。
...
// 按路径文本过滤锁文件及 .git 噪声，仅保留 Git index、HEAD 与普通工作文件。

...
const { map } = JSON.parse(readFileSync(".trellis/tasks/09-07-architecture-convergence/rust-ownership-plan.json", "utf8"));
...
console.log(`Updated exact Rust owner paths in ${count} instruction/spec files.`);

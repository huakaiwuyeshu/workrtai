...
Resolve source distro/cwd/config root, match projects and launch all six supported resume commands in the original environment. Never pass Linux cwd to Windows CreateProcess.
